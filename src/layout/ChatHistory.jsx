    ...
    return (
        <div className={"w-full h-full"}>
            <div className={"w-full h-[40vh] flex flex-col justify-center items-center mb-10"}>
                <p className={"w-full mb-4 text-[#9e9e9e] text-[10px] rounded-lg text-left"}>최근 검색 기록</p>
                <div className={"w-full h-[35vh] scrollbar-custom overflow-y-scroll mb-5"}
                     style={{maxHeight: "calc(100% - 28px"}}>
                    {chatBotRooms.length === 0 &&
                        <h2 className={"font-bold text-left hover:bg-gray-500 hover:cursor-pointer mb-1 rounded-lg"}>채팅
                            기록이 없습니다.</h2>}
                    {
                            ...
                            return (
                                <div key={index}
                                    ...
                                    <svg className={"hover:fill-red-500 z-10"}
                                         ...
                                         width="24" height="24" viewBox="0 0 36 36" fill="currentColor"
